    ...
    <header className={`header ${isScrolled ? 'scrolled glass-panel' : ''}`}>
      <div className="container header-content">
        ...
        <div className="header-actions">
          ...
          <a href="https://www.linkedin.com/in/mohdkaifrizvi" className="linkedin-btn" aria-label="LinkedIn" target="_blank" rel="noreferrer">
            <Linkedin size={20} />
          </a>
          <a href="mailto:kaiferizvi2006@gmail.com" className="gmail-btn" aria-label="Email">
            <img 
          ...
          <a href="#" target="_blank" rel="noreferrer" className="brochure-btn">
            <Download size={18} />
            Brochure
          </a>
      ...
      <div className={`mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
        <nav className="mobile-nav">
          ...
          <a href="#" target="_blank" rel="noreferrer" style={{ color: 'var(--accent-purple)' }}>Download Brochure</a>
